 ...
 */
abstract class DimensionHelper extends GenericDimensionHelper {
    ...
    protected void hasDimensionsInfo(DimensionInfo elevInfo, DimensionInfo timeInfo) {
        if (mode == Mode.WMS11) {
            String elevUnits =  elevInfo != null ? elevInfo.getUnits() : "";
            String elevUnitSymbol =  elevInfo != null ? elevInfo.getUnitSymbol() : "";
            declareWMS11Dimensions(timeInfo == null, elevInfo == null, elevUnits, elevUnitSymbol, null);
        }
    }

    protected void handleTimeDimension(String timeMetadata, String defaultTimeStr) {
    ...
    protected void handleElevationDimension(TreeSet<?> elevations, String elevationMetadata,
                                                     String units, String unitSymbol, String defaultValue) {
        if (mode == Mode.WMS11) {
    ...
    protected void handleCustomDimension(String name, String metadata, String defaultValue, String unit, String unitSymbol) {
    ...
    protected String getZDomainRepresentation(DimensionInfo dimension, TreeSet<?> values) {
    ...
    protected String getTemporalDomainRepresentation(DimensionInfo dimension, TreeSet<?> values) {
    ...
    protected String getCustomDomainRepresentation(String name, DimensionInfo dimension, List<String> values) {

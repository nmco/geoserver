...
public class RasterTimeDimensionDefaultValueTest extends WMSDimensionsTestSupport {
    ...
    public static void prepareFutureCoverageData(QName coverageName,
                                                 GeoServerDataDirectory dataDirectory, Catalog catalog) throws IOException {
     ...
     */
    public static void addRasterLayerFromDataDir(QName qName,
                                                 GeoServerDataDirectory dataDircetory, Catalog catalog) throws IOException {
        String prefix = qName.getPrefix();
        String name = qName.getLocalPart();

        // setup the data
        File file = new File(dataDircetory.root() + File.separator + prefix, name);

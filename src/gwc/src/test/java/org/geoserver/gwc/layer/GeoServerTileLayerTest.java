...
public class GeoServerTileLayerTest {
    ...
    public void testGetLegendsLayer() throws Exception {
        ...
        Map<String, org.geowebcache.config.legends.LegendInfo> legendsInfo = tileLayer.getLegendsInfo();
        assertThat(legendsInfo.size(), is(3));
        // default_style
        assertThat(legendsInfo.get("default_style"), notNullValue());
        assertThat(legendsInfo.get("default_style").getWidth(), is(20));
        assertThat(legendsInfo.get("default_style").getHeight(), is(20));
        ...
        assertThat(legendsInfo.get("alternateStyle-1").getWidth(), is(20));
        assertThat(legendsInfo.get("alternateStyle-1").getHeight(), is(20));

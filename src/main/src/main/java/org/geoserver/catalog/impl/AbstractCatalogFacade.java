...
public abstract class AbstractCatalogFacade implements CatalogFacade {
    ...
    public static final WorkspaceInfo _ANY_WORKSPACE = ANY_WORKSPACE;

    public static final NamespaceInfo _ANY_NAMESPACE = ANY_NAMESPACE;

    public static final WorkspaceInfo _NO_WORKSPACE = NO_WORKSPACE;

...
public abstract class TestsSupport extends WMSTestSupport {
    ...
    protected static final QName WATER_TEMPERATURE = new QName(MockData.SF_URI, "watertemp", MockData.SF_PREFIX);
    protected static final QName WATER_TEMPERATURE_FUTURE = new QName(MockData.SF_URI, "watertemp_future_generated", MockData.SF_PREFIX);
    protected static final QName WATER_TEMPERATURE_CUSTOM = new QName(MockData.SF_URI, "watertemp_custom", MockData.SF_PREFIX);
    ...
    protected void onSetUp(SystemTestData testData) throws Exception {
        ...
        testData.addRasterLayer(WATER_TEMPERATURE, "/org/geoserver/wms/dimension/watertemp.zip",
                null, Collections.emptyMap(), getClass(), getCatalog());
        RasterTimeDimensionDefaultValueTest.prepareFutureCoverageData(WATER_TEMPERATURE_FUTURE,
                this.getDataDirectory(), this.getCatalog());
        testData.addRasterLayer(WATER_TEMPERATURE_CUSTOM, "/org/geoserver/wms/dimension/custwatertemp.zip",
                null, Collections.emptyMap(), getClass(), getCatalog());
    }

...
public class MbtilesBlobStorePageTest extends GeoServerWicketTestSupport {
    ...
    public void testCreatingNewBlobStore() throws ConfigurationException {
        ...
        formTester.setValue("blobSpecificPanel:rootDirectory:border:paramValue", "/tmp/gwc");
        ...
        formTester.setValue("blobSpecificPanel:mbtilesMetadataDirectory:border:paramValue", "/tmp/gwc/mbtilesMetadata");
        // submit the form
